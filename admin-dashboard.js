...
//   零裸调用破坏风险；多文件 ES module 拆分为后续增量。
    ...
    window.__dash = {
        ...
        checkAuth, formatDbTypeLabel, formatDelay, viewMetrics,
    ...
    confirmDrFailover, createTaskFromModal, createValidationTask, deleteValidationTask, downloadDiagnosticsBundle, escapeAttr,
    escapeHtml, fetchAuditLogs, goToDrPage, goToPage, goToValidationPage, handleSort,
    handleTokenExpired, launchTask, logout, onMetricsTimeRangeChange, openAccountSettings, openChartModal,
    openCreateValidationModal, openDrConfig, openTaskConfig, refreshMetrics, removeFilterTag, removeTable,
    renderValidationWorkflowOptions, repairValidationTaskAction, selectAllPgTables, selectAllTables, selectSourceType, selectTargetType,
    setChartGrain, showDrTaskDetail, showTaskDetail, switchAdvTab, switchPage, toggleDatabase,
    toggleLatencyChart, toggleMetricsAutoRefresh, togglePgSchema, viewMetrics, viewValidationDetail
    });
})();
